    ...
    return (
        ...
        <div className="max-w-screen-xl mx-auto px-4 justify-between items-center gap-12 md:px-8 md:flex">
            <div className="text-white flex-1 max-w-xl">
                ...
                Stay ahead in your fitness journey with regular updates, new exercises, meal plans, and features added to the platform. 
                </p>
            </div>
            <div className="mt-6 md:mt-0">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-12 pr-3 py-2 text-gray-200 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg sm:max-w-xs"
                        />
                    </div>
